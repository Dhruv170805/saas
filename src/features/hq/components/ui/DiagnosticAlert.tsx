  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, textAlign: 'left' }}>
        ...
        <div className="hq-flex hq-gap-6" style={{ marginTop: '1rem', fontFamily: 'monospace', fontSize: '9px', color: theme.accent, opacity: 0.6, textTransform: 'uppercase', letterSpacing: '0.4em' }}>
          <span>{timestamp}</span>
