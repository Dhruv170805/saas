...
import { DbCustomer } from '@/core/db/schema'
import { useSettings, useTenant } from '@/hooks/useData'
                ...
                <div className="card" style={{ alignSelf: 'start' }}>
                    ...
                    {!settings?.phone && (
                        <div style={{ marginTop: '1rem', padding: '1rem', background: 'var(--warning)', color: 'black', borderRadius: 'var(--radius-sm)', fontSize: '0.85rem' }}>
                            <strong>⚠️ Heads up:</strong> You haven&apos;t set a Restaurant Phone Number in Settings. The WhatsApp links below will still work, but setting your number helps organize your business profile.
                        </div>
                    )}
                </div>
